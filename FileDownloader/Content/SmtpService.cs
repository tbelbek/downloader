...
namespace WebUI.Helpers
{
    public class SmtpService
    {
        ...
        public bool SendMail(string header, string body, string contactToSend)
        {
            IsSending = true;
            bool result = false;
            try
            {
                result = MailJob(header, body, contactToSend);
                IsSending = false;
            }
            catch (Exception ex)
            {
        ...
        public bool SendMail(string header, string body, List<string> contactsToSend)
        {
            IsSending = true;
            bool result = false;
            try
